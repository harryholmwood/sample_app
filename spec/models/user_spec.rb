...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[andy@foo,com user_at_foo.org example.user@foo.]
    addresses.each do |address|
  ...
  it "should reject email addresses identical other than case" do
    upcased_email = @attr[:email].upcase
    User.create!(@attr)
    user_with_upcased_email = User.new(@attr.merge(:email => upcased_email))
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return user on an email/password match" do
  ...
  describe "relationships" do
    ...
    it "should include the follower in the user.followers array" do
      @user.follow!(@followed)
